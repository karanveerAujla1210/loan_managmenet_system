...
const disbursementData = [
  { id: 1, customer: 'Rajesh Kumar', amount: '₹2,50,000', date: '2024-01-10', status: 'completed', reference: 'DIS-2024-001' },
  { id: 2, customer: 'Priya Singh', amount: '₹1,80,000', date: '2024-01-11', status: 'pending', reference: 'DIS-2024-002' },
  { id: 3, customer: 'Neha Sharma', amount: '₹1,50,000', date: '2024-01-12', status: 'processing', reference: 'DIS-2024-003' },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Track loan disbursements and fund transfers</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <p className="text-sm text-gray-500 mb-2">Pending Disbursements</p>
          <p className="text-3xl font-bold text-gray-900">₹3.3L</p>
          <p className="text-xs text-orange-600 mt-2">2 cases pending</p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <p className="text-sm text-gray-500 mb-2">Avg Disbursement</p>
          <p className="text-3xl font-bold text-gray-900">₹2.2L</p>
          <p className="text-xs text-blue-600 mt-2">Per loan</p>
        </div>
      </div>
